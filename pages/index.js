    ...
    return (
        <StyledHeader>
            ...
            <section className="user-info">
                ...
                <div>
                    <h2 className="profileTitle">{config.name}</h2>
                    <p className="profileDescription">{config.job}</p>
                </div>
                <div className="icon-conteiner">
                    <a className="socialLink" href={`https://github.com/MarioPonte`} target="_blank"><IconGit/></a>
                    <a className="socialLink" href={`https://www.linkedin.com/in/m%C3%A1rio-ponte/`} target="_blank"><IconLinkedin/></a>
                </div>
            </section>
        </StyledHeader>
    )
